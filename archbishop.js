...
export class Archbishop {
    ...
    /*Bishop moves*/
    _getAllLeftSquares(board, getSquare) {
        return this.position.getAllLeftPositions((pos) => getSquare(this.color, pos, board, () => pos.getLeftPosition()));
    }
    _getAllRightSquare(board, getSquare) {
        return this.position.getAllRightPositions((pos) => getSquare(this.color, pos, board, () => pos.getRightPosition()));
    }
    _getAllSkipTopRightSquares(board, getSquare) {
        return this.position.getAllSkipTopRightPositions((pos) => getSquare(this.color, pos, board, () => pos.getSkipTopRightPosition()));
    }
    _getAllSkipBottomRightSquares(board, getSquare) {
        return this.position.getAllSkipBottomRightPositions((pos) => getSquare(this.color, pos, board, () => pos.getSkipBottomRightPosition()));
    }
    _getAllSkipTopLeftSquares(board, getSquare) {
        return this.position.getAllSkipTopLeftPositions((pos) => getSquare(this.color, pos, board, () => pos.getSkipTopLeftPosition()));
    }
    _getAllSkipBottomLeftSquares(board, getSquare) {
        return this.position.getAllSkipBottomLeftPositions((pos) => getSquare(this.color, pos, board, () => pos.getSkipBottomLeftPosition()));
    }
    _allSquareMovesBishop(board) {
        const getSquare = (color, position, board, getNextPos) => Position.canGetNextPosition(color, position, board, getNextPos);
        const allLeftSquare = this._getAllLeftSquares(board, getSquare);
        const allRightSquares = this._getAllRightSquare(board, getSquare);
        const allSkipTopRightSquares = this._getAllSkipTopRightSquares(board, getSquare);
        const allSkipBottomRightSquares = this._getAllSkipBottomRightSquares(board, getSquare);
        const allSkipTopLeftSquares = this._getAllSkipTopLeftSquares(board, getSquare);
        const allSkipBottomLeftSquares = this._getAllSkipBottomLeftSquares(board, getSquare);
        return [
            ...allLeftSquare,
            ...allRightSquares,
    ...
    _defendedSquaresBishop(board) {
        const leftPositions = Position.getAllDefendedPositionsInDirection(this.position, board, (pos) => pos.getLeftPosition());
        const rightPositions = Position.getAllDefendedPositionsInDirection(this.position, board, (pos) => pos.getRightPosition());
        const skipTopRightPositions = Position.getAllDefendedPositionsInDirection(this.position, board, (pos) => pos.getSkipTopRightPosition());
        const skipBottomRightPositions = Position.getAllDefendedPositionsInDirection(this.position, board, (pos) => pos.getSkipBottomRightPosition());
        const skipTopLeftPositions = Position.getAllDefendedPositionsInDirection(this.position, board, (pos) => pos.getSkipTopLeftPosition());
        const skipBottomLeftPositions = Position.getAllDefendedPositionsInDirection(this.position, board, (pos) => pos.getSkipBottomLeftPosition());
        return [
            ...leftPositions,
            ...rightPositions,
...
//# sourceMappingURL=archbishop.js.map